                ...
                <form role="form" method="post" enctype="multipart/form-data"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="input" name="name" value="{{old('slogan',$company->slogan)}}" class="form-control" placeholder="">
                        </div>

                        <div class="form-group">
                            <label for="default">Dirección</label>
                            <input type="input" name="address" value="{{old('address',$company->address)}}" class="form-control"
                                   placeholder="">
                        </div>
